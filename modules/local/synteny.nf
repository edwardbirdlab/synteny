process SYNTENY {
    ...
    """
    #main code block
    python -m jcvi.compara.catalog ortholog ${sample_id} ${sample_id2} ${params.jcvi_ortholog_arguments} --cscore ${params.ortholog_cscore} --dist ${params.ortholog_dist} --min_siz ${params.ortholog_anchors}
